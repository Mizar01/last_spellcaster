...
Possible names for objects:
- switchlith: stone activated by thunnder magic. They open doors or activate mechanisms.
- focuslith: stone activating once at a time the four powers: fire, thunder, ice, wind.
...
Death:
  - when the player dies, he respawns at the start of the current area, all enemies respawn too.
